...
class ENTRY(GraphicsObject):
    ...
    def __init__(self,chart,sig_reset_all,_type,precision,change_lastprice,lastcandle, update_signal,_candles: JAPAN_CANDLE|HEIKINASHI|SMOOTH_CANDLE=[], high_color: str = '#089981', low_color: str = '#f23645') -> None:
