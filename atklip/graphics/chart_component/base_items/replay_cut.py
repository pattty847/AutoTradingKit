...
class ReplayObject(GraphicsObject):
    ...
    def __init__(self, chart) -> None:
        ...
        self.has: dict = {"name": "rectangle", "type": "drawtool", "id": id}
    ...
    def paint(self, p: QPainter, *args) -> None:
        ...
        # vr = self.viewRect()
        rect = QRectF(
            self._x, self.y_bottom, self.x_right - self._x, self.y_top - self.y_bottom
        )
        # print(vr,rect)
    ...
    def boundingRect(self) -> QRectF:
        ...
        self.y_bottom, self.y_top = self.chart.yAxis.range[0], self.chart.yAxis.range[1]
        return QRectF(
            self._x, self.y_top, self.x_right - self._x, self.y_top - self.y_bottom
        )
