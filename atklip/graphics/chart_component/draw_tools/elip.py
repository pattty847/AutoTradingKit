...
class Ellipse(ROI):
    ...
    **Arguments**
    ...
    def getArrayRegion(
        self, arr, img=None, axes=(0, 1), returnMappedCoords=False, **kwds
    ):
        """
        ...
        if returnMappedCoords:
            arr, mappedCoords = ROI.getArrayRegion(
                self, arr, img, axes, returnMappedCoords, **kwds
            )
        else:
