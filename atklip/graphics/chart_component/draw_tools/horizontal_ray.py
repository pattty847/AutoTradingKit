...
from pyqtgraph import functions as fn, Point, ROI
...
class HorizontalRayNoHandle(MyLineNoHandleROI):
    ...
    def mouseDragEvent(self, ev):
        ...
        if self.dragMode == "translate":
            ...
            self.setAngle(
                angle, centerLocal=ev.buttonDownPos(), snap=snap, finish=False
            )
    ...
    def mouseDragEvent(self, ev, axis=None):
        ...
        if not self.locked:
            ...
            if ev.button() == Qt.MouseButton.LeftButton:
                ...
                self.movePoint(
                    self.getHandles()[0], QPointF(newPosX, newPosY), finish=False
                )
