...
class BaseHandle(Handle, UIGraphicsItem):
    ...
    def setDeletable(self, b):
        ...
        if b:
            self.setAcceptedMouseButtons(
                self.acceptedMouseButtons() | Qt.MouseButton.RightButton
            )
        else:
            self.setAcceptedMouseButtons(
                self.acceptedMouseButtons() & ~Qt.MouseButton.RightButton
    ...
    def buildMenu(self):
        ...
        self.removeAction = menu.addAction(
            translate("ROI", "Remove handle"), self.removeClicked
        )
        return menu
