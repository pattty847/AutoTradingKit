...
class TrendlinesROI(BasePolyLineROI):
    ...
    def __init__(
        self, positions, closed=False, id=None, pos=None, drawtool=None, pen=None
    ):
    ...
    def addSegment(self, h1, h2, index=None):
        ...
        for h in seg.handles:
            ...
            h["item"].setAcceptedMouseButtons(
                h["item"].acceptedMouseButtons() | QtCore.Qt.MouseButton.LeftButton
