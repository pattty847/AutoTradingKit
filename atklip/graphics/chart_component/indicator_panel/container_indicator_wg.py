...
class IndicatorContainer(VWIDGET):
    ...
    def __init__(self, parent):
        ...
        self.sig_add_panel.connect(
            self.add_indicator_panel, Qt.ConnectionType.AutoConnection
        )
        self.sig_remove_panel.connect(
            self.remove_indicator_panel, Qt.ConnectionType.AutoConnection
        )
