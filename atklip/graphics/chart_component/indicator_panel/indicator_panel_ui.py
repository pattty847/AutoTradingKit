...
"")
        ...
        self.indicator_name = QLabel(self.frame)
        self.indicator_name.setObjectName(u"indicator_name")
        sizePolicy = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.indicator_name.sizePolicy().hasHeightForWidth())
        self.indicator_name.setSizePolicy(sizePolicy)
        self.indicator_name.setMinimumSize(QSize(0, 25))
        self.indicator_name.setMaximumSize(QSize(16777215, 25))
        font = QFont()
        ...
        self.indicator_name.setFont(font)
        self.indicator_name.setStyleSheet(u"color: #eaeaea;\n"
"font: 10pt \"Segoe UI\";")
        self.indicator_name.setScaledContents(True)
        self.indicator_name.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.indicator_name.setWordWrap(False)
        self.indicator_name.setMargin(0)

        self.horizontalLayout_2.addWidget(self.indicator_name)
    ...
    def retranslateUi(self, Form):
        ...
        self.indicator_name.setText(QCoreApplication.translate("Form", u"name_indicator", None))
