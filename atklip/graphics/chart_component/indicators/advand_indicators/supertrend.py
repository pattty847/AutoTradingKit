...
class BasicSuperTrend(GraphicsObject):
    ...
    def regen_indicator(self, setdata):
        ...
        self.has["name"] = (
            f"""SupperTrend {self.has["inputs"]["supertrend_length"]} {self.has["inputs"]["supertrend_atr_length"]} {self.has["inputs"]["supertrend_multiplier"]} {self.has["inputs"]["supertrend_atr_mamode"].name}"""
        )
