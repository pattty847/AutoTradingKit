...
class ATRSuperTrend(GraphicsObject):
    ...
    def __init__(self, chart) -> None:
        ...
        self.INDICATOR = SuperTrendWithStopLoss(
    ...
    def regen_indicator(self, setdata):
        ...
        self.has["name"] = (
            f"""SuperTrendvsSL {self.has["inputs"]["supertrend_length"]} {self.has["inputs"]["supertrend_atr_length"]} {self.has["inputs"]["supertrend_multiplier"]} {self.has["inputs"]["supertrend_atr_mamode"].name}"""
        )
    ...
    def set_Data(self, data):
        x_data, long_stoploss, short_stoploss, SUPERTd = (
            data[0],
            data[1],
            data[2],
            data[3],
