...
class BasicSTOCHRSI(GraphicsObject):
    """RSI"""
    ...
    def __init__(self, get_last_pos_worker, chart, panel) -> None:
        ...
        self.has: dict = {
            ...
            "styles": {
                "pen_stochrsi_line": "red",
                "width_stochrsi_line": 1,
                "style_stochrsi_line": Qt.PenStyle.SolidLine,
        ...
        self.stochrsi_line = PlotDataItem(pen="red")  # for z value
        self.stochrsi_line.setParentItem(self)
    ...
    def regen_indicator(self, setdata):
        ...
        self.has["name"] = (
            f"""STOCHRSI {self.has["inputs"]["mamode"].name} {self.has["inputs"]["period"]} {self.has["inputs"]["k_period"]} {self.has["inputs"]["d_period"]} {self.has["inputs"]["type"]}"""
        )
    ...
    def get_styles(self):
        styles = {
            "pen_stochrsi_line": self.has["styles"]["pen_stochrsi_line"],
            "width_stochrsi_line": self.has["styles"]["width_stochrsi_line"],
            "style_stochrsi_line": self.has["styles"]["style_stochrsi_line"],
    ...
    def update_styles(self, _input):
        ...
        if (
            _input == "pen_stochrsi_line"
            or _input == "width_stochrsi_line"
            or _input == "style_stochrsi_line"
        ):
            self.stochrsi_line.setPen(
                color=self.has["styles"]["pen_stochrsi_line"],
                width=self.has["styles"]["width_stochrsi_line"],
                style=self.has["styles"]["style_stochrsi_line"],
            )
        elif (
