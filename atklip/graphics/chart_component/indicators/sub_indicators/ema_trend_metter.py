...
class EMATrendMetter(GraphicsObject):
    ...
    def __init__(self, get_last_pos_worker, chart, panel) -> None:
        ...
        self.INDICATOR = EMA_TREND_METTER(
    ...
    def regen_indicator(self, setdata):
        ...
        self.has["name"] = (
            f"""EMA_TREND_METTER {self.has["inputs"]["base_ema_length"]} {self.has["inputs"]["ema_length_1"]} {self.has["inputs"]["ema_length_2"]} {self.has["inputs"]["ema_length_3"]}"""
        )
