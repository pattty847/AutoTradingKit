...
from atklip.controls.models import TSIModel
...
class BasicTSI(GraphicsObject):
    ...
    def __init__(self, get_last_pos_worker, chart, panel) -> None:
        ...
        self.INDICATOR = TSI(self.has["inputs"]["source"], self.model.__dict__)
    ...
    def regen_indicator(self, setdata):
        ...
        self.has["name"] = (
            f"""TSI {self.has["inputs"]["mamode"].name} {self.has["inputs"]["fast_period"]} {self.has["inputs"]["slow_period"]} {self.has["inputs"]["signal_period"]} {self.has["inputs"]["type"]}"""
        )
