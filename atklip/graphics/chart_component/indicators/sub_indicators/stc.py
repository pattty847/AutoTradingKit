...
class BasicSTC(PlotDataItem):
    ...
    def regen_indicator(self, setdata):
        ...
        self.has["name"] = (
            f"""STC {self.has["inputs"]["mamode"].name} {self.has["inputs"]["length_period"]} {self.has["inputs"]["fast_period"]} {self.has["inputs"]["slow_period"]} {self.has["inputs"]["type"]}"""
        )
    ...
    def get_styles(self):
        styles = {
            "pen_stc_line": self.has["styles"]["pen_stc_line"],
    ...
    def update_styles(self, _input):
        ...
        if (
            _input == "pen_stc_line"
            or _input == "width_stc_line"
            or _input == "style_stc_line"
        ):
            self.setPen(
                color=self.has["styles"]["pen_stc_line"],
                width=self.has["styles"]["width_stc_line"],
                style=self.has["styles"]["style_stc_line"],
            )
        elif (
            _input == "pen_stoch_line"
            or _input == "width_stoch_line"
            or _input == "style_stoch_line"
        ):
            self.stoch_line.setPen(
                color=self.has["styles"]["pen_stoch_line"],
                width=self.has["styles"]["width_stoch_line"],
                style=self.has["styles"]["style_stoch_line"],
            )
        elif (
            _input == "pen_macd_line"
            or _input == "width_macd_line"
            or _input == "style_macd_line"
        ):
            self.macd_line.setPen(
                color=self.has["styles"]["pen_macd_line"],
                width=self.has["styles"]["width_macd_line"],
                style=self.has["styles"]["style_macd_line"],
            )
