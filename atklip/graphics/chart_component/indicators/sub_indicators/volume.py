...
class Volume(GraphicsObject):
    ...
    def __init__(
        ...
        self.chart.jp_candle.sig_reset_all.connect(
            self.first_gen_data, Qt.ConnectionType.AutoConnection
        )
        self.chart.jp_candle.sig_add_candle.connect(
            self.update_asyncworker, Qt.ConnectionType.AutoConnection
        )
        self.chart.jp_candle.sig_update_candle.connect(
            self.update_asyncworker, Qt.ConnectionType.AutoConnection
        )
        self.chart.jp_candle.sig_add_historic.connect(
    ...
    def setData(self, data) -> None:
        ...
        [
            self.draw_volume(
                _open[index], _close[index], _volume[index], w, x_data[index]
            )
