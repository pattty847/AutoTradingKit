...
import numpy as np
from pyqtgraph import functions as fn, mkPen, GraphicsObject, mkBrush
...
class VolumeWithMA(GraphicsObject):
    ...
    def __init__(
        ...
        indicator_type: PD_MAType = PD_MAType.SMA,
        pen: str = "yellow",
        length: int = 5,
        _type: str = "volume",
    ) -> None:
    ...
    def regen_indicator(self, setdata):
        ...
        self.has["name"] = (
            f"""{self.has["inputs"]["mamode"].name} {self.has["inputs"]["length"]} {self.has["inputs"]["type"]}"""
        )
