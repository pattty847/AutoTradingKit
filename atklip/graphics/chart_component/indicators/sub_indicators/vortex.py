...
class BasicVTX(GraphicsObject):
    ...
    def __init__(self,get_last_pos_worker,chart,panel,id = None,clickable=True) -> None:
        ...
        self.INDICATOR  = VORTEX(parent=self,
    ...
    def get_styles(self):
        styles =  {"pen_vortex_line":self.has["styles"]["pen_vortex_line"],
    ...
    def update_styles(self, _input):
        ...
        if _input == "pen_vortex_line" or _input == "width_vortex_line" or _input == "style_vortex_line":
            self.vortex_line.setPen(color=self.has["styles"]["pen_vortex_line"], width=self.has["styles"]["width_vortex_line"],style=self.has["styles"]["style_vortex_line"])
    ...
    #     return self.vortex_line.boundingRect()
    def boundingRect(self) -> QRectF:
        ...
        if self.vortex_line.yData is None:
            ...
            h_low,h_high = np.nanmin(self.vortex_line.yData), np.nanmax(self.vortex_line.yData) 
        else:
            h_low,h_high = self._panel.yAxis.range[0],self._panel.yAxis.range[1]
