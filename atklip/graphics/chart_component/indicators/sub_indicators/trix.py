...
class BasicTRIX(GraphicsObject):
    ...
    def regen_indicator(self, setdata):
        ...
        self.has["name"] = (
            f"""TRIX {self.has["inputs"]["mamode"].name} {self.has["inputs"]["length_period"]} {self.has["inputs"]["signal_period"]} {self.has["inputs"]["type"]}"""
        )
    ...
    def get_styles(self):
        styles = {
            "pen_trix_line": self.has["styles"]["pen_trix_line"],
    ...
    def update_styles(self, _input):
        ...
        if (
            _input == "pen_trix_line"
            or _input == "width_trix_line"
            or _input == "style_trix_line"
        ):
            self.trix_line.setPen(
                color=self.has["styles"]["pen_trix_line"],
                width=self.has["styles"]["width_trix_line"],
                style=self.has["styles"]["style_trix_line"],
            )
        elif (
