...
from atklip.gui_components.components._pushbutton import Tradingview_Button
from atklip.gui_components import FluentIcon as FIF

class OBJECTS(QFrame):
    def __init__(self,parent:QWidget=None):
        ...
        self.splitToolButton = Tradingview_Button(FIF.OBJECT_DATA,self)
