...
from atklip.gui_components.components import Interval_Item
from atklip.gui_components.qfluentwidgets.components import HWIDGET,HBoxLayout,TitleLabel,RoundMenu
from atklip.gui_components.qfluentwidgets.common import isDarkTheme,setFont
if TYPE_CHECKING:
