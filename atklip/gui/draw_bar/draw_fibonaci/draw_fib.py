...
class FIBONACCI(QFrame):
    def __init__(
        ...
        self.fib_retracement = Card_Item(
            FIF.FIB_RETRACEMENT, "Fib Retracement", "FIBONACCI", self
        )
        self.fib_retracement_2 = Card_Item(
            FIF.FIB_RETRACEMENT, "Fib Retracement 2", "FIBONACCI", self
        )
        self.risk_reward_ratio = Card_Item(
            FIF.FIB_RETRACEMENT, "Risk Reward Ratio", "FIBONACCI", self
        )
