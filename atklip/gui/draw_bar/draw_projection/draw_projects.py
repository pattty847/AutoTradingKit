...
class PROJECTS(QFrame):
    def __init__(
        ...
        self.long_position = Card_Item(
            FIF.LONG_POSITION, "Long Position", "PROJECTION", self
        )
        self.short_position = Card_Item(
            FIF.SHORT_POSITION, "Short Position", "PROJECTION", self
        )
        ...
        self.date_price_range = Card_Item(
            FIF.DATE_PRICE_RANGE, "Date & Price Range", "MEASURER", self
        )
