...
class MEASURE(QFrame):
    def __init__(self, parent: QWidget = None, sig_draw_object_name=None):
        ...
        self.splitToolButton = Tradingview_Button(FIF.MEASURE, self)
        self.splitToolButton.setIconSize(QSize(25, 25))
        # self.splitToolButton.setContentsMargins(1,1,5,5)
    ...
    def set_current_tool(self, tool_infor):
        ...
        self.sig_draw_object_name.emit(
            (self.current_tool, self.is_enabled, "draw_trenlines")
        )
