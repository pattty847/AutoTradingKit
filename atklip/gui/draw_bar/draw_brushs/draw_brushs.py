...
class BRUSHS(QFrame):
    def __init__(
        ...
        self.arrow_mark_up = Card_Item(
            FIF.ARROW_MAKER_UP, "Arrow Mark Up", "BRUSHS", self
        )
        self.arrow_mark_down = Card_Item(
            FIF.ARROW_MAKER_DOWN, "Arrow Mark Down", "BRUSHS", self
        )
        ...
        self.rotated_rectangle = Card_Item(
            FIF.ROTATE_RECTANGLE, "Rotated Rectangle", "BRUSHS", self
        )
