...
from ..components.widgets.flyout import (
    Flyout,
    FlyoutViewBase,
...
class VolumeView(FlyoutViewBase):
    ...
    def setVolume(self, volume: int):
        ...
        self.volumeLabel.move(
            self.width() - 20 - tr.width(), self.height() // 2 - tr.height() // 2
        )
...
class VolumeButton(MediaPlayBarButton):
    ...
    def _postInit(self):
        ...
        self.volumeView.muteButton.clicked.connect(
            lambda: self.mutedChanged.emit(not self.isMuted)
        )
