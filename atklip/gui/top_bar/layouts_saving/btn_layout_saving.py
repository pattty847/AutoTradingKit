...
To continue delivering the best experience for our users, we need your support. Your sponsorship will directly fund:
    ...
    * Share this message with others who benefit from ATK. The more support we receive, the faster we can deliver new features and improvements.
    ...
    mr.BigD - Creator/Developer of ATK"""
        ...
        bank_tt = SubtitleLabel(
            "1. You can support me via Vietnamese bank account 👇️", self
        )
        ...
        self.payment_4 = HyperlinkButton(
            "https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=XTHUBP3TB5H7J",
            "Paypal sponsor 5$",
            self,
            FluentIcon.LINK,
        )
        self.payment_5 = HyperlinkButton(
            "https://www.paypal.com/ncp/payment/G9R3YNN89KR8Y",
            "Paypal sponsor 10$",
            self,
            FluentIcon.LINK,
        )
        self.payment_6 = HyperlinkButton(
            "https://www.paypal.com/ncp/payment/363TPLRF4NAF4",
            "Paypal sponsor 20$",
            self,
            FluentIcon.LINK,
        )

        self.payment_1 = HyperlinkButton(
            "https://www.paypal.com/webapps/billing/plans/subscribe?plan_id=P-0F53588022198101GM63BMVA",
            "Paypal subscribe 10$/month",
            self,
            FluentIcon.LINK,
        )
        self.payment_2 = HyperlinkButton(
            "https://www.paypal.com/webapps/billing/plans/subscribe?plan_id=P-06E5757414542143MM63BSGI",
            "Paypal subscribe 20$/month",
            self,
            FluentIcon.LINK,
        )
        self.payment_3 = HyperlinkButton(
            "https://www.paypal.com/webapps/billing/plans/subscribe?plan_id=P-00V92834XG336831FM63BTEQ",
            "Paypal subscribe 50$/month",
            self,
            FluentIcon.LINK,
        )

        label = SubtitleLabel(
            self.tr("3. You also sent some gift to me via binace transfer 👇️"), self
        )
        ...
        Youtube_Chanel = HyperlinkButton(
            "https://www.youtube.com/@AutoTradingKit",
            "Youtube Chanel",
            self,
            FluentIcon.LINK,
        )
        Facebook = HyperlinkButton(
            "https://www.facebook.com/che.linh.9096/",
            "Author's Facebook",
            self,
            FluentIcon.LINK,
        )
        Discord = HyperlinkButton(
            "https://discord.gg/UNDh5MyR", "Discord", self, FluentIcon.LINK
        )
        ATK_Facebook_Group = HyperlinkButton(
