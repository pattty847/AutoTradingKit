...
from atklip.gui.qfluentwidgets.components.date_time.fast_calendar_view import (
    FastCalendarView,
)
...
class DateTimeMenu(MovingWidget):
    def __init__(self, sig_remove_menu, parent: QWidget = None):
        ...
        self.btn_widget_layout.addWidget(
            self.btn_goto_close, 0, alignment=Qt.AlignmentFlag.AlignHCenter
        )
