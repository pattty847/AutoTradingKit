...
class CANDLES(HWIDGET):
    def __init__(self, parent: QWidget = None):
        ...
        self.candle = Candle_Item(
            FIF.CANDLE, "Japanese Candles", "CANDLES", self.splitToolButton
        )
        self.heikinashi = Candle_Item(
            FIF.HEIKINASHI, "Heikin Ashi", "CANDLES", self.splitToolButton
        )
        self.chodu = Candle_Item(
            FIF.CHOIDU, "Choidu Candle", "CANDLES", self.splitToolButton
        )
