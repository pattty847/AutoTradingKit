...
class RightMenu(VWIDGET):
    def __init__(self, parent: QWidget = None):
        ...
        self.advands = ICON_TEXT_BUTTON(
            self._parent, "Advand Idicators", FIF.ANHCHORED_VOLUME
        )
...
class IndicatorMenu(MovingWidget):
    def __init__(
        self, sig_remove_menu, sig_add_indicator_to_chart, parent: QWidget = None
    ):
        ...
        self.search_box.textChanged.connect(
            self.main_menu.ListIndicatorMenu.filter_table
        )
