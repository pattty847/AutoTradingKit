...
class Ui_right_bar(object):
    def setupUi(self, right_bar):
        if not right_bar.objectName():
            right_bar.setObjectName("right_bar")
        ...
        self._draw_layout.setObjectName("_draw_layout")

        self.verticalLayout_3.addLayout(self._draw_layout)

        self.verticalSpacer = QSpacerItem(
            20, 371, QSizePolicy.Minimum, QSizePolicy.Expanding
        )
        ...
        self._setting_layout.setObjectName("_setting_layout")
    ...
    def retranslateUi(self, right_bar):
        right_bar.setWindowTitle(QCoreApplication.translate("right_bar", "Frame", None))
