...
from atklip.gui.components._pushbutton import (
    Favorite_Button,
    CircleICon,
    Help_Button,
    Candle_Button,
)
from atklip.controls.ma_type import IndicatorType, PD_MAType
...
class Indicator_Item(CardWidget):
    ...
    def __init__(
        ...
        self.sig_add_remove_favorite, self.sig_add_indicator_to_chart = (
            sig_add_remove_favorite,
            sig_add_indicator_to_chart,
        )
        self.setContentsMargins(0, 0, 0, 0)
