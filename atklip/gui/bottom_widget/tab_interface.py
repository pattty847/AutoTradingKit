...
class BottomInterface(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.addSubInterface(
            self.PositionTable, "tabposition", self.tr("List of trades")
        )
        self.addSubInterface(self.overview, "taboverview", self.tr("Overview"))
        self.addSubInterface(self.property, "tabproperty", self.tr("Properties"))
        self.stackedWidget.currentChanged.connect(self.onCurrentIndexChanged)
        qrouter.setDefaultRouteKey(self.stackedWidget, self.PositionTable.objectName())
