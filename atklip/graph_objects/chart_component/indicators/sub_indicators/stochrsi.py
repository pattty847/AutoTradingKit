...
class BasicSTOCHRSI(GraphicsObject):
    ...
    def reset_indicator(self):
        ...
        self._INDICATOR = ta.stochrsi(close=df[f"{self.has["inputs"]["type"]}"],
                                  ...
                                  rsi_length=self.has["inputs"]["rsi_period"],
        ...
        stochrsi = self._INDICATOR[stochrsi_name].to_numpy()
    ...
    def get_styles(self):
        styles =  {"pen_stochrsi_line":self.has["styles"]["pen_stochrsi_line"],
    ...
    def update_styles(self, _input):
        ...
        if _input == "pen_stochrsi_line" or _input == "width_stochrsi_line" or _input == "style_stochrsi_line":
            self.stochrsi_line.setPen(color=self.has["styles"]["pen_stochrsi_line"], width=self.has["styles"]["width_stochrsi_line"],style=self.has["styles"]["style_stochrsi_line"])
