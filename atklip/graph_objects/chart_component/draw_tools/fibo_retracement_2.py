...
from atklip.graph_objects.pyqtgraph import TextItem, mkPen
from atklip.graph_objects.pyqtgraph.Point import Point
...
class FiboROI2(SpecialROI):
    ...
    def __init__(self, pos, size=..., angle=0, invertible=True, maxBounds=None, snapSize=1, scaleSnap=False, translateSnap=False, rotateSnap=False, parent=None, pen=None, hoverPen=None, handlePen=None, handleHoverPen=None, movable=True, rotatable=True, resizable=True, removable=False, aspectLocked=False, main=None, fibo_level=None, color_rect=None, color_line=None, color_borders=None,):
        ...
        self.temp_config = {}
        self.list_lines = []
        self.fibonacci_levels = [1.146, 1.0, 0.95, 0.9, 0.85, 0.8, 0.75, 0.7, 0.65, 0.6, 0.55, 0.5, 0.45, 0.4, 0.35, 0.3, 0.25, 0.2, 0.15, 0.1, 0.05, 0, -0.146] 
        self.colors_lines = [(79, 172, 82, 200), (255, 51, 69, 200),(255, 51, 69, 200), (255, 51, 69, 200), (255, 51, 69, 200), (255, 51, 69, 200), 
                (255, 51, 69, 200), (43, 106, 255, 200), (43, 106, 255, 200), (43, 106, 255, 200), (255, 255, 255, 200), (255, 255, 255, 200), 
                (255, 255, 255, 200), (43, 106, 255, 200), (43, 106, 255, 200), (43, 106, 255, 200), (79, 172, 82, 200), (79, 172, 82, 200), 
                (79, 172, 82, 200), (79, 172, 82, 200), (79, 172, 82, 200), (79, 172, 82, 200), (255, 51, 69, 200)]
        self.colors_borders = [(79, 172, 82, 0), (255, 51, 69, 0),(255, 51, 69, 0), (255, 51, 69, 0), (255, 51, 69, 0), (255, 51, 69, 0), 
                (255, 51, 69, 0), (43, 106, 255, 0), (43, 106, 255, 0), (43, 106, 255, 0), (255, 255, 255, 0), (255, 255, 255, 0), 
                (255, 255, 255, 0), (43, 106, 255, 0), (43, 106, 255, 0), (43, 106, 255, 0), (79, 172, 82, 0), (79, 172, 82, 0), 
                (79, 172, 82, 0), (79, 172, 82, 0), (79, 172, 82, 0), (79, 172, 82, 0), (255, 51, 69, 0)]
        self.colors_rect = [QColor(79, 172, 82, 40), QColor(255, 51, 69, 40),QColor(255, 51, 69, 40), QColor(255, 51, 69, 40), QColor(255, 51, 69, 40), QColor(255, 51, 69, 40), 
                QColor(255, 51, 69, 40), QColor(43, 106, 255, 40), QColor(43, 106, 255, 40), QColor(43, 106, 255, 40), QColor(255, 255, 255, 40), QColor(255, 255, 255, 40), 
                QColor(255, 255, 255, 40), QColor(43, 106, 255, 40), QColor(43, 106, 255, 40), QColor(43, 106, 255, 40), QColor(79, 172, 82, 40), QColor(79, 172, 82, 40), 
                QColor(79, 172, 82, 40), QColor(79, 172, 82, 40), QColor(79, 172, 82, 40), QColor(79, 172, 82, 40), QColor(255, 51, 69, 40)]
