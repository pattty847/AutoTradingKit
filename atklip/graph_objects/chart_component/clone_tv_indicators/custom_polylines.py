...
from atklip.graph_objects.pyqtgraph import PolyLineROI, TextItem, Point, ArrowItem, mkPen

draw_line_color = '#fca326'
epoch_period = 1e30


from ..draw_tools.custom_roi import SpecialROI, _FiboLineSegment
...
class RangePolyLine(MyPolyLine):     # for date price range
    ...
    def __init__(self, vb, chart, *args, **kwargs):
        ...
        self.chart.mousepossiton_signal.connect(self.setLastPoint)
