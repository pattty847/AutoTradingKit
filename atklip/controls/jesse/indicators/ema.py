...
from atklip.controls.jesse.helpers import get_candle_source, slice_candles


def ema(candles: pd.DataFrame, period: int = 5, source_type: str = "close", sequential: bool = True) -> Union[
    float, np.ndarray]:
    """
