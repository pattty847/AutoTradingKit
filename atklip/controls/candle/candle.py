        ...
        [
            self.gen_update(
                OHLCV(
                    ...
                    ohlcv[i][3],
                    ohlcv[i][4],
                    round((ohlcv[i][2] + ohlcv[i][3]) / 2, _precision),
                    round((ohlcv[i][2] + ohlcv[i][3] + ohlcv[i][4]) / 3, _precision),
                    round(
                        (ohlcv[i][1] + ohlcv[i][2] + ohlcv[i][3] + ohlcv[i][4]) / 4,
                        _precision,
                    ),
                    ohlcv[i][5],
                    ohlcv[i][0] / 1000,
        ...
        if self.first_gen:
            ...
            if _time == new_candle.time:
                ...
                if (
                    ...
                    or new_candle.high != last_candle.high
                    or new_candle.low != last_candle.low
                    or new_candle.open != last_candle.open
                ):
