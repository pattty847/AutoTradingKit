...
class SuperTrend(QObject):
    ...
    def __init__(self, _candles, dict_ta_params) -> None:
        ...
        self.xdata, self.SUPERTt, self.SUPERTd, self.SUPERTl, self.SUPERTs = (
            np.array([]),
            np.array([]),
            np.array([]),
            np.array([]),
    ...
    def callback_first_gen(self, future: Future):
        ...
        self.xdata, self.SUPERTt, self.SUPERTd = (
    ...
    def callback_update(self, future: Future):
        ...
        last_SUPERTt = df["SUPERTt"].iloc[-1]
        last_SUPERTd = df["SUPERTd"].iloc[-1]
        self.df.loc[self.df.index[-1], ["index", "SUPERTt", "SUPERTd"]] = [
            last_index,
            last_SUPERTt,
            last_SUPERTd,
        ]
        self.xdata[-1], self.SUPERTt[-1], self.SUPERTd[-1] = (
            last_index,
            last_SUPERTt,
            last_SUPERTd,
        )
