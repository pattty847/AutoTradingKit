...
class ADOSC(Indicator):
    ...
    inputs = [
        {"name": "fast", "space": list(range(1, 20)), "default": [3]},
        {"name": "slow", "space": list(range(1, 40)), "default": [10]},
    ]
    ...
    def calc(self, data, fast, slow):
        ...
        df.ta.adosc(fast=int(fast), slow=int(slow), cumulative=True, append=True)
