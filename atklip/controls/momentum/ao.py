...
from atklip.controls.pandas_ta.momentum import ao
import numpy as np
import pandas as pd
...
class AO(QObject):
    ...
    def __init__(self, _candles, dict_ta_params: dict = {}) -> None:
        ...
        self._name = f"AO {self.fast} {self.slow}"
    ...
    def change_input(self, candles=None, dict_ta_params: dict = {}):
        ...
        if dict_ta_params != {}:
            ...
            ta_param = f"{obj_id}-{ta_name}-{self.fast}-{self.slow}"
