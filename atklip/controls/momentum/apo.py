...
from atklip.controls.pandas_ta.utils import tal_ma, v_mamode, v_offset
from atklip.controls.pandas_ta.utils import v_pos_default, v_series, v_talib
...
def apo(
    ...
    if Imports["talib"] and mode_tal:
        from atklip.controls.talib import APO
