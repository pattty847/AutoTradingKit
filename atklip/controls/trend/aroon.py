...
class Aroon(QObject):
    ...
    def __init__(self,_candles,dict_ta_params) -> None:
        ...
        self.xdata,self.aroon_up , self.aroon_down = np.array([]),np.array([]),np.array([])
    ...
    def get_data(self,start:int=0,stop:int=0):
        ...
        if start == 0 and stop == 0:
            ...
            aroon_up,aroon_down=self.aroon_up[start:stop],self.aroon_down[start:stop]
    ...
    def callback_first_gen(self, future: Future):
        ...
        self.xdata,self.aroon_up , self.aroon_down = self.df["index"].to_numpy(),\
    ...
    def callback_gen_historic_data(self, future: Future):
        ...
        self.aroon_down = np.concatenate((_df["aroon_down"].to_numpy(), self.aroon_down))
        self.is_genering = False
        if self.first_gen == False:
            self.first_gen = True
            self.is_genering = False
    ...
    def callback_update(self,future: Future):
        ...
        last_aroon_up = df["aroon_up"].iloc[-1]
        last_aroon_down = df["aroon_down"].iloc[-1]
        self.df.loc[self.df.index[-1], ['index', 'aroon_up', 'aroon_down']] = [last_index, last_aroon_up, last_aroon_down]
        self.xdata[-1],self.aroon_up[-1] , self.aroon_down[-1]  = last_index,last_aroon_up,last_aroon_down
        #self.is_current_update = True
