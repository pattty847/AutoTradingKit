...
from atklip.indicators.talipp.indicators.ROC import ROC
...
class KST(Indicator):
    ...
    def __init__(self,
        ...
        self.roc1 = ROC(roc1_period,_type=_type)
        self.roc2 = ROC(roc2_period,_type=_type)
        self.roc3 = ROC(roc3_period,_type=_type)
        self.roc4 = ROC(roc4_period,_type=_type)
        ...
        self.signal_line = MAFactory.get_ma(ma_type, signal_period,_type= _type)
