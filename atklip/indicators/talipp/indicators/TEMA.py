...
class TEMA(Indicator):
    ...
    def __init__(self, period: int,
        ...
        self.ema = EMA(period,_type=_type)
        self.ema_ema = EMA(period, input_indicator=self.ema,_type=_type)
        self.ema_ema_ema = EMA(period, input_indicator=self.ema_ema,_type=_type)
