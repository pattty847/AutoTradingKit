...
from atklip.indicators.talipp.indicators.RSI import RSI
...
class StochRSI(Indicator):
    ...
    def __init__(self, rsi_period: int,
        ...
        self.rsi = RSI(rsi_period,_type= _type)
        self.add_sub_indicator(self.rsi)

        self.smoothed_k = MAFactory.get_ma(ma_type, k_smoothing_period,_type= _type)
        self.add_managed_sequence(self.smoothed_k)

        self.values_d = MAFactory.get_ma(ma_type, d_smoothing_period,_type= _type)
