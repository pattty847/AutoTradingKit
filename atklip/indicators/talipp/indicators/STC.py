...
from atklip.indicators.talipp.indicators.MACD import MACD, MACDVal
from atklip.indicators.talipp.indicators.Stoch import Stoch, StochVal
from atklip.indicators.talipp.input import SamplingPeriodType
from atklip.indicators.talipp.ma import MAType
...
class STC(Indicator):
    ...
    def __init__(self, fast_macd_period: int,
        ...
        self.macd = MACD(fast_macd_period, slow_macd_period, slow_macd_period,_type= _type)
