...
from atklip.indicators.talipp.indicators import BB, DonchianChannels, KeltnerChannels
...
from atklip.indicators.talipp.ohlcv import OHLCV, ValueExtractor
...
class TTM(Indicator):
    ...
    def _calculate_new_value(self) -> Any:
        ...
        if has_valid_values(self.deltas, self.period):
            ...
            if float(self.period) == 0 or self.denom == 0:
                return None
