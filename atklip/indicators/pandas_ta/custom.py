...
from atklip.indicators.pandas_ta
from atklip.indicators.pandas_ta import AnalysisIndicators
...
ones from atklip.indicators.pandas_ta core module and modifying them.
