...
from atklip.indicators.pandas_ta.maps import RATE
from atklip.indicators.pandas_ta.utils._validate import v_series
from atklip.indicators.pandas_ta.utils._math import linear_regression
from atklip.indicators.pandas_ta.utils._time import total_time
...
def max_drawdown(
    ...
    """
    from atklip.indicators.pandas_ta.performance import drawdown
    close = v_series(close)
...
def optimal_leverage(
    ...
    """
    from atklip.indicators.pandas_ta.performance import log_return, percent_return
    close = v_series(close)
