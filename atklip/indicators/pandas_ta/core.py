...
from atklip.indicators.pandas_ta._typing import *
from atklip.indicators.pandas_ta import *
...
class AnalysisIndicators(object):
    ...
    def indicators(self,
        ...
        if indicator_count > 0:
            from atklip.indicators.pandas_ta.candles.cdl_pattern import ALL_PATTERNS
